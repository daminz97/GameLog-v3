"""
Django settings for project_gamelog project.
...
INSTALLED_APPS = [
    'app_gamelog.apps.AppGamelogConfig',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'app_gamelog.context_processor.notification_dot',
            ],
        },
    },
]

WSGI_APPLICATION = 'project_gamelog.wsgi.application'
...
AUTH_USER_MODEL = 'app_gamelog.User'
